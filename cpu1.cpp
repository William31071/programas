...
void mostrarTiempo (clock_t tiempo){
	...
	int main(){
		...
		// Tomamos un número double (decimal largo) y le aplicamos logaritmo natural sum = sum + log(double(i));
		sum = sum + log(double(i));
		// Mostramos el tiempo que le tomó ejecutar mostrarTiempo (tiempo);
